...
- Name: plot-status-live-refresh.spec.js >> Operations staff with plot visibility see Plots table update after actions >> approve → plot shows "sold" in the Ops Plots table
- Location: tests/e2e/plot-status-live-refresh.spec.js:328:7

# Error details

```
Error: apiRequestContext.post: connect EAFNOSUPPORT ::1:5000 - Local (undefined:undefined)
Call log:
  - → POST http://localhost:5000/api/dealer/login
