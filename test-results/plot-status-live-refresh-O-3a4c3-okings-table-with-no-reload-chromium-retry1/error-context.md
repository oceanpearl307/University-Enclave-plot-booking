...
- Name: plot-status-live-refresh.spec.js >> Operations live new-booking stream >> a booking created after login appears in the bookings table with no reload
- Location: tests/e2e/plot-status-live-refresh.spec.js:392:7
