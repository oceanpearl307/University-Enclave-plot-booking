...
- Name: plot-status-live-refresh.spec.js >> Operations Staff approve/reject flow updates booking + plot >> reject → booking goes "rejected" live and the plot returns to "available"
- Location: tests/e2e/plot-status-live-refresh.spec.js:281:7
